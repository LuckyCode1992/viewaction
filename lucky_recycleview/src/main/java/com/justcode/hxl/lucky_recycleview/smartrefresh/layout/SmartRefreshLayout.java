package com.justcode.hxl.lucky_recycleview.smartrefresh.layout;
...
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.api.DefaultRefreshFooterCreator;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.api.DefaultRefreshHeaderCreator;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.api.DefaultRefreshInitializer;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.api.RefreshContent;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.api.RefreshFooter;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.api.RefreshHeader;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.api.RefreshInternal;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.api.RefreshKernel;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.api.RefreshLayout;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.api.ScrollBoundaryDecider;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.constant.DimensionStatus;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.constant.RefreshState;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.constant.SpinnerStyle;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.footer.BallPulseFooter;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.header.BezierRadarHeader;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.impl.RefreshContentWrapper;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.impl.RefreshFooterWrapper;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.impl.RefreshHeaderWrapper;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.listener.OnLoadMoreListener;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.listener.OnMultiPurposeListener;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.listener.OnRefreshListener;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.listener.OnRefreshLoadMoreListener;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.listener.OnStateChangedListener;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.util.DelayedRunnable;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.util.DensityUtil;
import com.justcode.hxl.lucky_recycleview.smartrefresh.layout.util.ViscousFluidInterpolator;
...
import static com.justcode.hxl.lucky_recycleview.smartrefresh.layout.util.DensityUtil.dp2px;
import static com.justcode.hxl.lucky_recycleview.smartrefresh.layout.util.SmartUtil.fling;
import static com.justcode.hxl.lucky_recycleview.smartrefresh.layout.util.SmartUtil.getColor;
import static com.justcode.hxl.lucky_recycleview.smartrefresh.layout.util.SmartUtil.isContentView;
...
//    }
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.justcode.hxl.lucky_recycleview.smartrefresh.layout.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.justcode.hxl.lucky_recycleview.smartrefresh.layout.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
