...
public class Crop {
    ...
    public Crop withAspect(int x, int y) {
        cropIntent.putExtra(Crop.Extra.ASPECT_X, x);
        cropIntent.putExtra(Crop.Extra.ASPECT_Y, y);
        return this;
    }
    ...
    public Crop asSquare() {
        cropIntent.putExtra(Crop.Extra.ASPECT_X, 1);
        cropIntent.putExtra(Crop.Extra.ASPECT_Y, 1);
        return this;
    }
    ...
    public Crop withMaxSize(int width, int height) {
        ...
        cropIntent.putExtra(Crop.Extra.MAX_Y, height);
        return this;
    }
    ...
    public static Throwable getError(Intent result) {
        return (Throwable) result.getSerializableExtra(Crop.Extra.ERROR);
    }
