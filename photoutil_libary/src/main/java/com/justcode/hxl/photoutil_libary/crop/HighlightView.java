...
public class HighlightView {
    ...
    private void initStyles(Context context) {
        ...
        try {
            ...
            handleMode = HighlightView.HandleMode.values()[attributes.getInt(R.styleable.CropImageView_showHandles, 0)];
        } finally {
            attributes.recycle();
        }
    }
    ...
    protected void draw(Canvas canvas) {
        ...
        if (!hasFocus()) {
            ...
            if (handleMode == HighlightView.HandleMode.Always ||
                    (handleMode == HighlightView.HandleMode.Changing && modifyMode == HighlightView.ModifyMode.Grow)) {
                drawHandles(canvas);
            }
        }
    }
