...
import com.justcode.hxl.tools.二维码条形码验证码.QrBarTool;
...
public class ActivityScanerCode extends AppCompatActivity {
            ...
            try {
                ...
                if (rawResult != null) {
                    if (mScanerListener == null) {
                        Toast.makeText(this, "结果请在这里处理", Toast.LENGTH_LONG).show();
                    } else {
    ...
    public void vibrateOnce(Context context, int millisecond) {
