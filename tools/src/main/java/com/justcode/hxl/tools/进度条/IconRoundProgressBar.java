package com.justcode.hxl.tools.进度条;
...
public class IconRoundProgressBar extends BaseRoundProgressBar implements View.OnClickListener {
    ...
    public IconRoundProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public IconRoundProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initStyleable(Context context, AttributeSet attrs) {
        ...
        int colorIconBackgroundDefault = Color.parseColor("#5f5f5f");
