package com.justcode.hxl.tools.keyboard_pwd;
...
public class PayPwdEditText extends RelativeLayout{
     ...
     */
    public void initStyle(int bgdrawable, int pwdlength, float splilinewidth, String splilinecolor, String pwdcolor, int pwdsize)
    {
     ...
     * @param pwdsize 密码字体大小
     */
    public void initShowInput(int bgcolor, int pwdlength, float slpilinewidth, String splilinecolor, String pwdcolor, int pwdsize)
    {
        //添加密码框父布局
        ...
        for(int i = 0; i < textViews.length; i++)
        {
            ...
            textViews[i].setTextColor(Color.parseColor(pwdcolor));
