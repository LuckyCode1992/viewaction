package com.justcode.hxl.仿阿里巴巴下拉刷新;
...
import com.justcode.hxl.alibabaxiala.AlipayContainerLayout;
import com.justcode.hxl.alibabaxiala.AlipayScrollView;
import com.justcode.hxl.viewaction.R;
import com.justcode.hxl.仿阿里巴巴下拉刷新.utils.CustomizedToast;
import com.justcode.hxl.仿阿里巴巴下拉刷新.utils.Utils;
import com.justcode.hxl.仿阿里巴巴下拉刷新.widget.TopLinearLayout;
...
public class AlibabaActivity extends AppCompatActivity {
    ...
    private View initContentView(LayoutInflater inflater) {
        View view = inflater.inflate(R.layout.home_content_alibaba, null);
    ...
    private View initTopLayout(LayoutInflater inflater) {
        View topLinearLayout = inflater.inflate(R.layout.home_top_layout_alibaba, null);
